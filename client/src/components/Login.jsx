...
const Login = () => {
  ...
  const { showLogin } = useState(AppContext);
  useEffect(() => {
  ...
  return (
    <div className="absolute top-0 left-0 right-0 bottom-0 z-10 backdrop-vlur-sm bg-black/30 flex justify-center items-center">
